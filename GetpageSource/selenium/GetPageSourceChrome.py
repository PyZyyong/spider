...
class  GetPageSourceChrome(GetpageSource.selenium.GetPageSource.GetPageSource):
    def  __init__(self,url):
        #父类初始化
        GetpageSource.selenium.GetPageSource.GetPageSource.__init__(self,url)
    def  getsource(self):
        driver = selenium.webdriver.Chrome()  # 调用火狐狸
...
'''
testfirefox= GetPageSourceChrome("http://www.baidu.com")
