...
class  GetPageSourceEdge(GetpageSource.selenium.GetPageSource.GetPageSource):
    def  __init__(self,url):
        #父类初始化
        GetpageSource.selenium.GetPageSource.GetPageSource.__init__(self,url)
    def  getsource(self):
        driver = selenium.webdriver.Edge()  # 调用火狐狸
...
'''
testfirefox= GetPageSourceEdge("http://www.baidu.com")
