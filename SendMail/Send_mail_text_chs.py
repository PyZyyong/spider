...
class Send_mail_text_chs(SendMail.Send_mail_base.Sendmail_Base):
...
'''
mymail=Send_mail_text_chs("yincheng8848@163.com","tsinghua8848","smtp.163.com",25,["yincheng8848@163.com","18310556724@163.com"])
mymail.login()
mymail.sendmail("hello  sunqing中国","go go  go泰国","yincheng","sunqing")
