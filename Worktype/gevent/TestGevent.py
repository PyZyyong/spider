...
import Worktype.gevent.gevent_task
...
mygevent_task=Worktype.gevent.gevent_task.Gevent_task()#初始化,对象
#mygevent_task.run()
go_task=[ gevent.spawn(mygevent_task.run,
                       ...
                       GetPageData.regex.GetDataFunc_re.get_zhaopin)          for url  in urllist    ]
