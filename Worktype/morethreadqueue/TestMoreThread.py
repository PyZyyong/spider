#coding:utf-8
import Worktype.morethreadqueue.BaseThread  #引用多线程的线程模块
...
threadlist=[]
for  url  in urllist:
    mythd=Worktype.morethreadqueue.BaseThread.BaseThread(GetpageSource.urllib2Go.GetPageSourceURLLIB.GetPageSourceURLLIB,
                                                    url,
